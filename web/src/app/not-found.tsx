  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-950 p-6">
      <div className="text-center max-w-md">
        <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-2xl bg-emerald-500/10 border border-emerald-500/20">
          <Compass className="h-10 w-10 text-emerald-500" />
        </div>
        <p className="text-sm font-semibold text-emerald-500 mb-2">404</p>
